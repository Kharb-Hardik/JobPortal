    ...
    <footer className="bg-slate-200 py-12">
      <div className="container mx-auto px-6 lg:px-16">
        <div className="flex flex-col lg:flex-row justify-between items-center lg:items-start">
          ...
          <div className="mb-6 lg:mb-0 lg:w-1/3 text-center lg:text-left">
            <h2 className="text-3xl font-bold">Job Hunt</h2>
            <p className="text-gray-400 mt-2">Connecting talent with opportunity</p>
            <p className="text-gray-500 mt-4 text-sm">© 2024 Your Company. All rights reserved.</p>
          </div>
          
          {/* Navigation Links */}
          <div className="mb-6 lg:mb-0 lg:w-1/3 text-center">
          ...
          {/* Social Media Links */}
          <div className="lg:w-1/3 flex justify-center lg:justify-end space-x-6">
